...
public class GuiSeleccionarCliente extends JDialog implements ActionListener, FocusListener, KeyListener {
	...
	public static void main(String[] args) {
		try {
			GuiSeleccionarCliente dialog = new GuiSeleccionarCliente(null);
	 ...
	 * Create the dialog.
	 */
	public GuiSeleccionarCliente(JDialog gcc) {
		super(gcc, true);
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		setResizable(false);
		setTitle("Clientes");
		setBounds(100, 100, 657, 457);
		...
		btnSeleccionar.setBounds(245, 372, 150, 35);
	...
	private void anadirTabla(Cliente p) {
	...
	private void seleccionar() {
		if(tblLista.getSelectedRow()==-1)
			...
			p = ArregloClientes.buscarCliente(codigo);
			dispose();
		}
	}
